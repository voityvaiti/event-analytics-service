 ...
 * to} window, and the {@code timezone} the time buckets were computed in. {@code totalEvents} is
 * the grand total across all buckets — the event count in the window, independent of grouping.
 *
